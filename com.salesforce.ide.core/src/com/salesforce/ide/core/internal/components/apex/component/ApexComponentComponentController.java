...
public class ApexComponentComponentController extends ComponentController {

    public ApexComponentComponentController() throws ForceProjectException {
        super(new ApexComponentModel());
    }
