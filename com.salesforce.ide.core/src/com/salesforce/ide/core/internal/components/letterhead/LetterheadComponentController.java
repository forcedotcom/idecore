...
public class LetterheadComponentController extends ComponentController {

    public LetterheadComponentController() throws ForceProjectException {
        super(new LetterheadModel());
    }
