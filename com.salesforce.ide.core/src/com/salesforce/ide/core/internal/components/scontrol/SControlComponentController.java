...
public class SControlComponentController extends ComponentController {

    public SControlComponentController() throws ForceProjectException {
        super(new SControlModel());
    }
