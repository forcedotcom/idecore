...
public class Connection {
    ...
    public void setClientCallOptions() throws ForceConnectionException {
        getPartnerConnection().setCallOptions(getClientId(), null, null, debugExceptions, getPlatform(), getApplication(), null);
        if (logger.isDebugEnabled()) {
    ...
    public void setNonCallOptions() throws ForceConnectionException {
        partnerConnection.setCallOptions("", null, null, debugExceptions, getPlatform(), getApplication(), null);
        if (logger.isDebugEnabled()) {
