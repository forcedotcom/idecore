...
public abstract class BasePackageService extends BaseService {
    ...
    protected IFileBasedResultAdapter waitForResult(IFileBasedResultAdapter result, MetadataStubExt metadataStubExt, OperationStats operationStats, IProgressMonitor monitor) throws ForceRemoteException,
