...
public class Component extends ComponentResource {
    ...
    private String getCompositeMetadataPath(String fromPath) {
        ...
        if (metadataInstance || Constants.FOLDER.equals(componentType)
                && fromPath.contains(getMetadataFileExtensionPart())) {
    ...
    public String getDefaultTemplateString() {
        ...
        return Utils.isNotEmpty(defaultTemplate) ? getNewBodyFromTemplateString(defaultTemplate)
    ...
    public final void loadComponentProperties(IFile file) {
        ...
        loadAdditionalFileProperties(file);
    }
     ...
     * @param file
     */
    protected void loadAdditionalFileProperties(IFile file) {
        // not implemented
    }
    ...
    public final boolean hasLocalChanged() {
        ...
        if (getBodyChecksum() != getOriginalBodyChecksum()) {
            if (logger.isInfoEnabled()) {
                logger.info("Current local " + getFullDisplayName() + " has changed.  Current body checksum ["
    ...
    public String toString() {
        ...
        retValue.append("Component ( ").append("componentType=").append(this.componentType).append(TAB)
                .append("subComponentType=").append(this.secondaryComponentType).append(TAB).append("id=")
                .append(this.id).append(TAB).append("name=").append(this.name).append(TAB).append("fileName=")
                .append(this.fileName).append(TAB).append("fullName=").append(this.fullName).append(TAB)
                .append("packageName=").append(this.packageName).append(TAB).append(super.toString()).append(TAB)
                .append("defaultFolder=").append(this.defaultFolder).append(TAB).append("displayName=")
                .append(this.displayName).append(TAB).append("fileExtension=").append(this.fileExtension).append(TAB)
                .append("state=").append(this.state).append(TAB).append("apiVersion=").append(this.apiVersion)
                .append(TAB).append("webComponentTypeUrlPart=").append(this.webComponentTypeUrlPart).append(TAB)
                .append("webUrlPart=").append(this.webComponentUrlPart).append(TAB).append("caseSensitive=")
                .append(this.caseSensitive).append(TAB).append("createdById=").append(this.createdById).append(TAB)
                .append("createdByName=").append(this.createdByName).append(TAB).append("createdDate=")
                .append(Utils.getDisplayDate(this.createdDate)).append(TAB).append("lastModifiedById=")
                .append(this.lastModifiedById).append(TAB).append("lastModifiedByName=")
                ...
                .append(this.alphaNumeric).append(TAB).append("namespacePrefix=").append(this.namespacePrefix)
                .append(TAB).append("managed=").append(this.installed).append(TAB).append("active=")
                .append(this.active).append(TAB).append("metadataFileExtension=").append(this.metadataFileExtension)
                .append(TAB).append("metadataComposite=").append(this.metadataComposite).append(TAB)
                .append("withinFolder=").append(this.withinFolder).append(TAB).append("folderName=")
                ...
                .append("remoteDeleteable=").append(this.remoteDeleteable).append(TAB)
    ...
    public String toStringLite() {
        ...
        retValue.append("Component ( ").append("displayName=").append(getFullDisplayName()).append(TAB).append("path=")
                .append(getResourceFilePath()).append(TAB).append("id=").append(this.id).append(TAB)
                .append("metadata=").append(this.metadataComposite).append(TAB).append("packageManifest=")
                .append(this.packageManifest).append(TAB).append("managed=").append(this.installed).append(TAB)
                .append(super.toStringLite()).append(" )");
        return retValue.toString();
    }
}
