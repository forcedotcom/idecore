...
public class HomePageComponentWizardComposite extends GenericComponentWizardComposite {

    public HomePageComponentWizardComposite(Composite parent, int style, String componentTypeDisplayName) {
