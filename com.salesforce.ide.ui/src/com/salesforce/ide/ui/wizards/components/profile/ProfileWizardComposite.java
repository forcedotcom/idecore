...
public class ProfileWizardComposite extends GenericComponentWizardComposite {

    public ProfileWizardComposite(Composite parent, int style, String componentTypeDisplayName) {
