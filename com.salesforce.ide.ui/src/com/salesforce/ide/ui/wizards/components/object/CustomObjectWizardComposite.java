...
public class CustomObjectWizardComposite extends GenericComponentWizardComposite {

    public CustomObjectWizardComposite(Composite parent, int style, String componentTypeDisplayName) {
    ...
    protected void initializeControls() {
        ...
        createLabelAndNameText(null, grpProperties, true);
    }
}
