...
public class LetterheadWizardComposite extends GenericComponentWizardComposite {

    public LetterheadWizardComposite(Composite parent, int style, String componentTypeDisplayName) {
