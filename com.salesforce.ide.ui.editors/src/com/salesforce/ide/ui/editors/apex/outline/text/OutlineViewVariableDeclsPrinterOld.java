 ...
 * @author nchen
 */
final class OutlineViewVariableDeclsPrinterOld implements Printer<VariableDecls> {
    private final Printer<TypeRef> typeRefPrinter;
    private final Printer<Identifier> identifierPrinter;

    public OutlineViewVariableDeclsPrinterOld(PrinterFactory astPrinterFactory) {
