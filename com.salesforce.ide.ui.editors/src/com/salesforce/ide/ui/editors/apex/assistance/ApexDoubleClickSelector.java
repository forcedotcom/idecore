...
/**
 * Derives from org.eclipse.jdt.internal.ui.text.java.JavaDoubleClickSelector and is governed by the terms of the
 * original copyright on that file.
 */
public class ApexDoubleClickSelector implements ITextDoubleClickStrategy {
    ...
    protected static final char[] fgBrackets = { '{', '}', '(', ')', '[', ']', '"', '"' };

    /*
     * Create a JavaDoubleClickSelector.
     */
    public ApexDoubleClickSelector() {
        super();
    }
