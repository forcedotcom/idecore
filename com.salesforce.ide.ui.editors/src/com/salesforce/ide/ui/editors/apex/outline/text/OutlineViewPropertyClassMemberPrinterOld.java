...
final class OutlineViewPropertyClassMemberPrinterOld implements Printer<PropertyMember> {

    private final Printer<TypeRef> typeRefPrinter;
    private final Printer<Identifier> identifierPrinter;

    public OutlineViewPropertyClassMemberPrinterOld(PrinterFactory printerfactory) {
