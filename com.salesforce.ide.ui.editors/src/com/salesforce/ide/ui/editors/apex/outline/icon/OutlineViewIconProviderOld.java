...
public class OutlineViewIconProviderOld implements IOutlineViewElementHandlerOld<Image> {
    ...
    AccessorFlags computeAccessorFlags(Iterable<Modifier> modifiers) {
        ...
        for (Modifier modifier : modifiers) {
            ModifierFlagsBitFlipperOld switchBlock = new ModifierFlagsBitFlipperOld(flags);
