...
public class ApexPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    public ApexPreferencePage() {
    }

    public ApexPreferencePage(String title) {
        super(title);
    }

    public ApexPreferencePage(String title, ImageDescriptor image) {
        super(title, image);
    }
