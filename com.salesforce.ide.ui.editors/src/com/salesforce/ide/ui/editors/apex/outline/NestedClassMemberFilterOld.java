 ...
 * 
 */
public class NestedClassMemberFilterOld extends BlockMember.SwitchBlockWithDefault {
    ...
    public NestedClassMemberFilterOld() {
    ...
    public void _case(InnerClassMember x) {
        if (x.body != null && x.body.members != null) {
            children.addAll(Arrays.asList(ApexOutlineContentProviderOld.validBlockMembers(x.body.members.values)));
        }
    }
    ...
    public void _case(InnerEnumMember x) {
        if (x.body != null && x.body.members != null) {
            children.addAll(ApexOutlineContentProviderOld.validIdentifiers(x.body.members.values).toList());
        }
    }
