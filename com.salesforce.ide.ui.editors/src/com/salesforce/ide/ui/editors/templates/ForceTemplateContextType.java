...
public abstract class ForceTemplateContextType extends TemplateContextType {

    public ForceTemplateContextType() {
        addGlobalResolvers();
    }

    public ForceTemplateContextType(String id) {
        super(id);
        addGlobalResolvers();
    }

    public ForceTemplateContextType(String id, String name) {
        super(id, name);
        addGlobalResolvers();
    }
