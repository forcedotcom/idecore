...
public enum ComponentTypeEnum {
    ...
    ApexComponent(
            ...
            true,
            true,
            new ComponentTypeEnum.ComponentTypeTestInfo("Visualforce Component", "components", ".component",
                    "ApexComponent", true)),
    ApexPage(
            "ApexPage",
    ...
    AnalyticSnapshot(
            ...
            true,
            false,
            new ComponentTypeEnum.ComponentTypeTestInfo(null, "analyticSnapshots", ".snapshot",
                    Constants.ANALYTIC_SNAPSHOT, false)),

    AppMenu("AppMenu", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "appMenus", ".appMenu", Constants.APP_MENU, true)),
    ...
    ApprovalProcess(
            ...
            true,
            true,
            new ComponentTypeEnum.ComponentTypeTestInfo(null, "approvalProcess", ".approvalProcess",
                    Constants.APP_MENU, true)),

    AuthProvider("AuthProvider", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "authproviders", ".authprovider", Constants.AUTH_PROVIDER, true)),

    CallCenter("CallCenter", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "callCenters", ".callCenter", Constants.CALL_CENTER, true)),

    Community("Community", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "communities", ".community", Constants.COMMUNITY, true)),

    ConnectedApp("ConnectedApp", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "connectedapps", ".connectedapp", Constants.CONNECTED_APP, true)),
    ...
    CustomApplication(
            ...
            true,
            true,
            new ComponentTypeEnum.ComponentTypeTestInfo("Custom Application", "applications", ".app",
                    Constants.CUSTOM_APPLICATION, true)),
    ...
    CustomApplicationComponent(
            ...
            true,
            true,
            new ComponentTypeEnum.ComponentTypeTestInfo("Custom Application Component", "customApplicationComponents",
                    ".customApplicationComponent", Constants.CUSTOM_APPLICATION_COMPONENT, true)),

    CustomDataType("CustomDataType", false, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "labels",
            ".labels", "CustomLabels", true)),

    CustomLabels("CustomLabels", true, false, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "labels",
            ".labels", "CustomLabels", true)),

    CustomMetadata("CustomMetadata", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "customMetadata", ".md", Constants.CUSTOM_METADATA, true)),
    ...
    CustomObjectTranslation(
            ...
            false,
            false,
            new ComponentTypeEnum.ComponentTypeTestInfo(null, "objectTranslations", ".objectTranslation",
                    "CustomObjectTranslation", true)),

    CustomPageWebLink("CustomPageWebLink", true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "weblinks", ".weblink", "CustomPageWebLink", false)),

    CustomPermission("CustomPermission", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "customPermissions", ".customPermission", Constants.CUSTOM_PERMISSION, true)),

    CustomSite(Constants.CUSTOM_SITE, false, false, false, new ComponentTypeEnum.ComponentTypeTestInfo(null, "sites",
            ".site", Constants.CUSTOM_SITE, true)),

    CustomTab("CustomTab", true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "tabs", ".tab",
            "CustomTab", true)),
    ...
    DataCategoryGroup(
            ...
            true,
            false,
            new ComponentTypeEnum.ComponentTypeTestInfo(null, "datacategorygroups", ".datacategorygroup",
                    Constants.DATACATEGORYGROUP, true,
                    new ComponentTypeWebUrlPart("/category/datacategorysetup.apexp"), new ComponentWebUrlPart(
                            "/category/datacategorysetup.apexp?"))),

    Dashboard("Dashboard", false, false, true),

    Document("Document", false, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "documents", ".document",
            "Document", false)),
    ...
    EntitlementProcess(
            ...
            true,
            true,
            new ComponentTypeEnum.ComponentTypeTestInfo(null, "entitlementProcesses", ".entitlementProcess",
                    Constants.ENTITLEMENT_PROCESS, true)),

    EmailTemplate("EmailTemplate", false, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "email",
            ".email", "EmailTemplate", false)),

    EntitlementTemplate("EntitlementTemplate", false, true, false, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "entitlementTemplates", ".entitlementtemplate", Constants.ENTITLEMENT_TEMPLATE, true,
            new ComponentTypeWebUrlPart("/551"), new ComponentWebUrlPart(""), new DisplayName("Entitlement Template"))),

    Folder("Folder", false, true, true),

    FieldSet("FieldSet", null, true, false, false, false),

    FlexiPage("FlexiPage", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "flexipages", ".flexipage", Constants.FLEXI_PAGE, true)),

    Group("Group", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "groups",
    ...
    HomePageComponent(
            ...
            true,
            true,
            new ComponentTypeEnum.ComponentTypeTestInfo("HomePage Component", "homePageComponents",
                    ".homePageComponent", "HomePageComponent", true)),
    ...
    HomePageLayout(
            ...
            true,
            true,
            new ComponentTypeEnum.ComponentTypeTestInfo("HomePage Layout", "homePageLayouts", ".homePageLayout",
                    "HomePageLayout", true)),
    ...
    LiveChatAgentConfig(
            ...
            true,
            true,
            new ComponentTypeEnum.ComponentTypeTestInfo(null, "liveChageAgentConfigs", ".liveChatAgentConfig",
                    Constants.LIVE_CHAT_AGENT_CONFIG, true)),

    LiveChatButton("LiveChatButton", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(
            null, "liveChatButtons", ".liveChatButton", Constants.LIVE_CHAT_BUTTON, true)),
    ...
    LiveChatDeployment(
            ...
            true,
            true,
            new ComponentTypeEnum.ComponentTypeTestInfo(null, "liveChatDeployments", ".liveChatDeployment",
                    Constants.LIVE_CHAT_DEPLOYMENT, true)),

    MilestoneType("MilestoneType", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(
            null, "milestoneTypes", ".milestoneType", Constants.MILESTONE_TYPE, true)),

    Network("Network", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "networks", ".networks", Constants.NETWORK, true)),

    PackageManifest("PackageManifest", true, true, true),

    Portal(Constants.PORTAL, false, false, false, new ComponentTypeEnum.ComponentTypeTestInfo(null, "portals",
            ".portal", Constants.PORTAL, true)),

    PostTemplate("PostTemplate", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "postTemplates", ".postTemplate", Constants.POST_TEMPLATE, true)),
    ...
    QuickAction("QuickAction", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "quickActions", ".quickAction", Constants.QUICK_ACTION, true)),

    RemoteSiteSetting("RemoteSiteSetting", false, true, false, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "remoteSiteSettings", ".remoteSite", Constants.REMOTE_SITE_SETTING, true, new ComponentTypeWebUrlPart(
                    "/0rp"), new ComponentWebUrlPart(""), new DisplayName("Remote Site Setting"))),
    ...
    Role("Role", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "roles",
            ".role", Constants.ROLE, true)),

    SamlSsoConfig("SamlSsoConfig", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(
            null, "samlssoconfigs", ".samlssoconfig", Constants.SAML_SSO_CONFIG, true)),
    ...
    Settings("Settings", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "settings", ".setting", Constants.SETTING, true)),

    SharingSet("SharingSet", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "sharingSets", ".sharingSet", Constants.SHARING_SET, true)),

    Skill("Skill", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "skills",
            ".skill", Constants.SKILL, true)),

    SiteDotCom("SiteDotCom", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "siteDotComSites", ".site", Constants.SITE_DOT_COM, true)),

    StandardObject("StandardObject", false, false, true),

    StaticResource("StaticResource", true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "staticresources", ".resource", "StaticResource", true)),
    ...
    Territory("Territory", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "territories", ".territory", Constants.TERRITORY, true)),

    Translations(Constants.TRANSLATIONS, false, false, false, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "translations", ".translation", "Translations", true)),
    ...
    XOrgHub("XOrgHub", null, false, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "xorghubs", ".xorghub", Constants.X_ORG_HUB, true)),

    PermissionSet("PermissionSet", null, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null,
            "permissionsets", ".permissionset", "PermissionSet", false, new ComponentTypeWebUrlPart("0PS"),
            new ComponentWebUrlPart(""), new DisplayName("Permission Set"))),

    Flow("Flow", null, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "flows", ".flow",
            "Flow", false, new ComponentTypeWebUrlPart("300?setupid=InteractionProcesses"), new ComponentWebUrlPart(
                    "designer/designer.apexp#Id="), new DisplayName("Flow"))),

    Queue("Queue", null, true, true, true, true, new ComponentTypeEnum.ComponentTypeTestInfo(null, "queues", ".queue",
            "Queue", false, new ComponentTypeWebUrlPart("p/own/Queue/d?setupid=Queues"), new ComponentWebUrlPart(""),
    ...
    private ComponentTypeEnum(String type, Class<? extends ComponentController> componentComponentController,
            boolean creatable, boolean defaultRetrieve, boolean deletable, boolean packageable) {
        this.typeName = type;
    ...
    private ComponentTypeEnum(String type, Class<? extends ComponentController> componentComponentController,
            boolean creatable, boolean defaultRetrieve, boolean deletable, boolean packageable, boolean isException) {
        this.typeName = type;
        this.creatable = creatable;
        this.componentComponentController = componentComponentController;
        this.defaultRetrieve = defaultRetrieve;
    ...
    public String getPackageXMLTypeIdentifier() {
        return IdeTestUtil.isNotEmpty(componentTypeTestInfo) ? componentTypeTestInfo.getPackageXMLTypeIdentifier()
                : null;
    }
    ...
    public String getComponentTypeWebUrlPart() {
        return IdeTestUtil.isNotEmpty(componentTypeTestInfo) ? componentTypeTestInfo.getComponentTypeWebUrlPart()
                .toString() : null;
    }

    public String getComponentWebUrlPart() {
        return IdeTestUtil.isNotEmpty(componentTypeTestInfo) ? componentTypeTestInfo.getComponentWebUrlPart()
                .toString() : null;
    }
    ...
    public static class ComponentTypeTestInfo {
        ...
        public ComponentTypeTestInfo(String wizardName, String parentFolderName, String fileExtension,
                String packageXMLTypeIdentifier, boolean isWildCardSupported) {
        ...
        public ComponentTypeTestInfo(String wizardNameIfAny, String parentFolderName, String fileExtension,
                String packageXMLTypeIdentifier, boolean isWildCardSupported,
                ComponentTypeWebUrlPart componentTypeWebUrlPart, ComponentWebUrlPart componentWebUrlPart) {
        ...
        public ComponentTypeTestInfo(String wizardNameIfAny, String parentFolderName, String fileExtension,
                ...
                DisplayName displayName) {
            this(wizardNameIfAny, parentFolderName, fileExtension, packageXMLTypeIdentifier, isWildCardSupported,
                    componentTypeWebUrlPart, componentWebUrlPart);
            this.displayName = displayName;
        }
